...
The endpoint that receives messages only queues the messages received. This way messages are less likely to miss delivery, since they  
are dequeued from a queue.
...
--MQCommon - standard contracts for the API and the app itself. This abstracts the rabbitmq usage in the main app.
